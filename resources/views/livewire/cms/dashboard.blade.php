                            ...
                            <div class="card-body px-4">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-9 col-information">
                                        ...
                                        <h6 style="font-size: 26px;" class="font-extrabold mb-0">{{ $total_kelas }}</h6>
                                    </div>
                                </div> 
                            </div>
                        </div>
                            ...
                            <div class="card-body px-4">
                                <div class="row">
                                    ...
                                    <div class="col-md-9 col-lg-12 col-xl-12 col-xxl-9 col-information">
                                        ...
                                        <h6 style="font-size: 26px;" class="font-extrabold mb-0">{{ $total_mata_pelajaran }}</h6>
                                    </div>
                                </div> 
                            </div>
                        </div>
                            ...
                            <div class="card-body px-4">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-9 col-information">
                                        ...
                                        <h6 style="font-size: 26px;" class="font-extrabold mb-0">{{ $total_modul }}</h6>
                                    </div>
                                </div> 
                            </div>
                        </div>
