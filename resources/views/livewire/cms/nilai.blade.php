                                        ...
                                        <table class="table table-hover table-striped" style="width:100%">
                                            ...
                                            <tbody>
                                                @forelse($get_detail as $d)
                                                    <tr>
                                                        <td>{{ $d->nama }}</td>
                                                        <td><input type="number" class="form-control" value="{{ $d->ph1 }}" min="0" max="100" step="1" oninput="if(this.value < 0) this.value = 0; if(this.value > 100) this.value = 100;" wire:change="savePh1({{ $d->id }}, $event.target.value)"></td>
                                                        <td><input type="number" class="form-control" value="{{ $d->ph2 }}" min="0" max="100" step="1" oninput="if(this.value < 0) this.value = 0; if(this.value > 100) this.value = 100;" wire:change="savePh2({{ $d->id }}, $event.target.value)"></td>
                                                        <td><input type="number" class="form-control" value="{{ $d->uts }}" min="0" max="100" step="1" oninput="if(this.value < 0) this.value = 0; if(this.value > 100) this.value = 100;" wire:change="saveUts({{ $d->id }}, $event.target.value)"></td>
                                                        <td><input type="number" class="form-control" value="{{ $d->uas }}" min="0" max="100" step="1" oninput="if(this.value < 0) this.value = 0; if(this.value > 100) this.value = 100;" wire:change="saveUas({{ $d->id }}, $event.target.value)"></td>
                                                    </tr>
                                                @empty
                                                    <tr>
                                                        <td colspan="100" class="text-center">
