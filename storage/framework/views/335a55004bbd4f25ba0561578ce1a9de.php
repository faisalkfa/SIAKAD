<script src="<?php echo e(asset('assets/static/js/components/dark.js')); ?>" data-navigate-once="true"></script>
<script src="<?php echo e(asset('assets/extensions/perfect-scrollbar/perfect-scrollbar.min.js')); ?>" data-navigate-once="true"></script>
<script src="https://unpkg.com/feather-icons" data-navigate-once="true"></script>
<script src="<?php echo e(asset('assets/compiled/js/app.js')); ?>" data-navigate-once="true"></script>
        ...
        btn_logout.addEventListener('click', () => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    fetch('<?php echo e(route('auth.logout')); ?>', {
                        method: 'POST',
                        headers: {
...
<?php /**PATH C:\Users\user\0 A SIDANG AKHIR\CODE\resources\views/components/javascript.blade.php ENDPATH**/ ?>