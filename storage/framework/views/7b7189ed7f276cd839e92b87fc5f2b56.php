    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="<?php echo e(url('/')); ?>/cms/profile/simpanProfile" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <img src="<?php echo e(asset('storage/guru/' . $image)); ?>" style="width: 100%;">
                        <div class="mb-3">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="nip" value="<?php echo e($nip); ?>">
                        </div>
                        <div class="mb-3">
...
<?php /**PATH C:\Users\user\0 A SIDANG AKHIR\CODE\resources\views/livewire/cms/profile-guru.blade.php ENDPATH**/ ?>