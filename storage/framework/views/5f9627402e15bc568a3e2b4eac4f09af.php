                            ...
                            <div class="card-body px-4">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-9 col-information">
                                        ...
                                        <h6 style="font-size: 26px;" class="font-extrabold mb-0"><?php echo e($kelas_sekarang->nama); ?></h6>
                                    </div>
                                </div> 
                            </div>
                        </div>
                            ...
                            <div class="card-body px-4">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-9 col-information">
                                        ...
                                        <h6 style="font-size: 26px;" class="font-extrabold mb-0"><?php echo e($average); ?></h6>
                                    </div>
                                </div> 
                            </div>
                        </div>
...
</script><?php /**PATH C:\Users\user\0 A SIDANG AKHIR\CODE\resources\views/livewire/cms/dashboard-siswa.blade.php ENDPATH**/ ?>