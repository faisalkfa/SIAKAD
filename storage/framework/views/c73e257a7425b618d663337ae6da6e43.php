...
<body>
    ...
    <div id="content">
        <img src="<?php echo e(asset('kop-surat.png')); ?>" style="width: 100%; margin-bottom: 10px;">
        <table class="no-border" style="width: 55%; float: left; margin-left: 20px;">
            ...
            <tr>
                ...
                <td>:</td>
                <td style="padding-left: 5px;"><?php echo e($head->nama); ?></td>
            </tr>
            <tr>
                <td style="width: 38%; text-align: left;">Nomor Induk/NISN</td>
                <td>:</td>
                <td style="padding-left: 5px;"><?php echo e($head->nisn); ?></td>
            </tr>
        </table>
        <table class="no-border" style="width: 35%; float: right;  margin-right: 20px;">
            <tr>
                ...
                <td style="width: 1%;">:</td>
                <td style="padding-left: 5px;"><?php echo e($head->kode_kelas); ?></td>
            </tr>
            <tr>
                <td style="width: 30%;"></td>
                <td style="width: 38%; text-align: left;">Semester</td>
                <td>:</td>
                <td style="padding-left: 5px;"><?php echo e($head->semester); ?></td>
            </tr>
            <tr>
                <td style="width: 30%;"></td>
                <td style="width: 38%; text-align: left;">Tahun Pelajaran</td>
                <td>:</td>
                <td style="padding-left: 5px;"><?php echo e(date('Y')); ?></td>
            </tr>
        </table>
        <br><br><br><br><br><br>
        <div style="margin-left: 20px; margin-right: 20px;">
            <table class="bordered">
                ...
                <tbody>
                    ...
                    <?php $__currentLoopData = $detail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($no); ?></td>
                            <td><?php echo e($d->mata_pelajaran); ?></td>
            ...
            <table class="bordered" style="width: 35%; margin-top: -10px;">
                <tr>
                    ...
                    <td style="width: 1%;">:</td>
                    <td style="padding-left: 5px; width: 5%;"><?php echo e($absensi->total_sakit); ?></td>
                </tr>
                <tr>
                    <td style="width: 30%; text-align: left;">Izin</td>
                    <td>:</td>
                    <td style="padding-left: 5px; width: 5%;"><?php echo e($absensi->total_izin); ?></td>
                </tr>
                <tr>
                    <td style="width: 30%; text-align: left;">Tanpa Keterangan</td>
                    <td>:</td>
                    <td style="padding-left: 5px; width: 5%;"><?php echo e($absensi->total_alpa); ?></td>
                </tr>
            </table>
            <br><br>
            <p style="text-align: right;">Bandar Lampung, <?php echo e(\Carbon\Carbon::parse(date('Y-m-d'))->locale('id')->isoFormat('D MMMM YYYY')); ?></p>
            <p style="text-align: right; padding-right: 5px;">Wali Kelas, <?php echo e($head->guru); ?></p>
            <br><br><br>
            <p style="text-align: right; padding-right: 5px;">NIP. <?php echo e($head->nip); ?></p>
        </div>
...
<?php /**PATH C:\Users\user\0 A SIDANG AKHIR\CODE\resources\views/pdf/nilai.blade.php ENDPATH**/ ?>