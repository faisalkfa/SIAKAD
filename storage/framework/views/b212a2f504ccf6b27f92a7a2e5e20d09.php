...
<?php endif; ?>
                                            ...
                                            <tbody>
                                                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $get_detail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                    <tr>
                                                        <td><?php echo e($d->nama); ?></td>
                                                        <td><input type="number" class="form-control" value="<?php echo e($d->ph1); ?>" min="0" max="100" step="1" oninput="if(this.value < 0) this.value = 0; if(this.value > 100) this.value = 100;" wire:change="savePh1(<?php echo e($d->id); ?>, $event.target.value)"></td>
                                                        <td><input type="number" class="form-control" value="<?php echo e($d->ph2); ?>" min="0" max="100" step="1" oninput="if(this.value < 0) this.value = 0; if(this.value > 100) this.value = 100;" wire:change="savePh2(<?php echo e($d->id); ?>, $event.target.value)"></td>
                                                        <td><input type="number" class="form-control" value="<?php echo e($d->uts); ?>" min="0" max="100" step="1" oninput="if(this.value < 0) this.value = 0; if(this.value > 100) this.value = 100;" wire:change="saveUts(<?php echo e($d->id); ?>, $event.target.value)"></td>
                                                        <td><input type="number" class="form-control" value="<?php echo e($d->uas); ?>" min="0" max="100" step="1" oninput="if(this.value < 0) this.value = 0; if(this.value > 100) this.value = 100;" wire:change="saveUas(<?php echo e($d->id); ?>, $event.target.value)"></td>
                                                    </tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                                    <tr>
                                                        <td colspan="100" class="text-center">
...
</script><?php /**PATH C:\Users\user\0 A SIDANG AKHIR\CODE\resources\views/livewire/cms/nilai.blade.php ENDPATH**/ ?>